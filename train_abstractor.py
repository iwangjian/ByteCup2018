...
def configure_net(vocab_size, emb_dim, n_hidden, bidirectional, n_layer):
    ...
    net_args['dropoute'] = 0.2  # dropout to remove words from embedding layer (0 = no dropout)
    net_args['dropouti'] = 0.2  # dropout for input embedding layers (0 = no dropout)
...
def main(args):
    ...
    train_batcher, val_batcher = build_batchers(word2id, args.data, args.cuda, args.debug)
