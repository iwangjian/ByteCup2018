...
def main(args):
    ...
    train_batcher, val_batcher = build_batchers(args.data, args.net_type, word2id,
                                                args.cuda, args.debug)
    # make net
    net, net_args = configure_net(args.net_type, len(word2id), args.emb_dim, args.conv_hidden,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lstm_hidden', type=int, action='store', default=512,
    ...
    parser.add_argument('--max_sent', type=int, action='store', default=20,
