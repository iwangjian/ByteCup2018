...
finished_files_dir = "./data/tokenized/finished_files"
...
def write_to_bin(url_file, out_file, makevocab=False):
    ...
    story_fnames = url_list  # no need hash operation
    ...
    with open(out_file, 'wb') as writer:
        for idx, s in enumerate(story_fnames):
            ...
            if os.path.isfile(os.path.join(train_tokenized_stories_dir, s)):
                ...
                check_num_stories(train_tokenized_stories_dir, num_expected_train_stories)
                check_num_stories(valid_tokenized_stories_dir, num_expected_valid_stories)
                raise Exception("Tokenized stories directories %s and %s contain correct number of files but story file \
                  %s found in neither." % (train_tokenized_stories_dir, valid_tokenized_stories_dir, s))
...
if __name__ == '__main__':
    ...
    check_num_stories(valid_stories_dir, num_expected_valid_stories)
    check_num_stories(test_stories_dir, num_expected_test_stories)
