...
class BasicTrainer(object):
    ...
    def __init__(self, pipeline, save_dir, ckpt_freq, patience,
        ...
        self._logger = tensorboardX.SummaryWriter(os.path.join(save_dir, 'log'))
        if not os.path.exists(os.path.join(save_dir, 'ckpt')):
    ...
    def checkpoint(self):
        ...
        self._pipeline.checkpoint(os.path.join(self._save_dir, 'ckpt'), self._step, val_metric)
